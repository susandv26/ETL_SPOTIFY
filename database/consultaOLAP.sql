...
--LLENADO DIM_TIEMPO
 ...
 SELECT A.ID_REPRODUCCION, 
       ...
       END AS CUATRIMESTRE,
       DATENAME(weekday, CAST(A.FECHA_REPRODUCCION AS DATE)) AS NOMBRE_DIA,
       DATENAME(month, CAST(A.FECHA_REPRODUCCION AS DATE)) AS NOMBRE_MES
